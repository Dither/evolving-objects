...
namespace eo
{
    ...
    /** Populator is a helper class for general operators GenOp
	...
	*/
	 ...
	 *   SeqPopulator and SelectivePopulator
	 */
    ...
    */
    ...
    /** SelectivePopulator an Poplator that uses an SelectOne to select guys.
    ...
    */
	...
	SelectivePopulator(const Pop<EOT>& _pop, Pop<EOT>& _dest, SelectOne<EOT>& _sel)
