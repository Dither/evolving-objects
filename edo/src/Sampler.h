...
#ifndef _edo_Sampler_h
#define _edo_Sampler_h
...
{
    template < typename D >
    class Sampler : public eo::UF< D&, typename D::EOType >
    {
    public:
	typedef typename D::EOType EOType;

	Sampler(Bounder< EOType > & bounder)
	...
	*/
    ...
    private:
	//BounderNo<EOType> _dummy_bounder;

	//! Bounder functor
	Bounder< EOType > & _bounder;
