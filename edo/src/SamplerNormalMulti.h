...
#ifndef _edo_SamplerNormalMulti_h
#define _edo_SamplerNormalMulti_h
...
{
    template< class EOT >
    class SamplerNormalMulti : public Sampler< NormalMulti< EOT > >
    {
    public:
	...
	SamplerNormalMulti( Bounder< EOT > & bounder )
	    : Sampler< NormalMulti< EOT > >( bounder )
	{}

	EOT sample( NormalMulti< EOT >& distrib )
	{
...
#endif // !_edo_SamplerNormalMulti_h
