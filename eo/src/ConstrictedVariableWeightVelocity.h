...
//-----------------------------------------------------------------------------
// ConstrictedVariableWeightVelocity.h
// (c) OPAC 2007
/*
...
#ifndef CONSTRICTEDVARIABLEWEIGHTVELOCITY_H
#define CONSTRICTEDVARIABLEWEIGHTVELOCITY_H
...
namespace eo
{
    ...
    /** Inertia variable + constriction velocity for particle swarm optimization. Derivated from abstract Velocity,
     ...
     *   @ingroup Variators
     */
    template < class POT > class ConstrictedVariableWeightVelocity:public Velocity < POT >
    {
	 ...
	 */
	ConstrictedVariableWeightVelocity (Topology < POT > & _topology,
...
#endif /*CONSTRICTEDVARIABLEWEIGHTVELOCITY_H*/
